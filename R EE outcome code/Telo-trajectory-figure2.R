...
SLAb.plotLong(Ab1=(d$TS2[d$tr=="Nutrition + WSH"]),Ab2=(d$TS3[d$tr=="Nutrition + WSH"]),mu1=t(T2.mu.ci[3,]),mu2=t(T3.mu.ci[3,]),diff=diff[3],labels=c("",""),letter="N+WSH",ylabel=TRUE, ysize=c(.5,3), point_col = 2)
