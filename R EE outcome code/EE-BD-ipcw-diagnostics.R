...
pca_res <- data.frame(tr=d$tr, miss=d$Lact1.miss, pca1=pca, pca2=pca2)

ggplot(data=pca_res, aes(x=pca1, y=pca2)) +
      geom_point(aes(colour=tr, shape=factor(miss))) + theme_bw()
