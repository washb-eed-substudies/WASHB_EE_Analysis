...
#
# Test positivity violations of ipcw analysis
# by including covariate-screening algorithms
# in SL
#---------------------------------------
...
#Set SL library
lib <- c("SL.mean","SL.glm","SL.glmnet")
...
#     temp<-washb_tmle(Y=log(Y[,i]), Delta=miss[,i], tr=d$tr, W=NULL, id=d$block, pair=NULL, family="gaussian", contrast= contrasts[[j]], Q.SL.library = lib, seed=12345, print=T)
#     cat(i," : ",j, "\n")
...
# temp<-washb_tmle(Y=log(Y[,i]), Delta=miss[,i], tr=d$tr, W=Wlist[[i]], id=d$block, pair=NULL, family="gaussian", contrast= contrasts[[j]], Q.SL.library = lib, seed=12345, print=T)
# 
...
#Extract estimates
l1_adj_ipcw_sl_M<-res_adj[[1]]
l2_adj_ipcw_sl_M<-res_adj[[4]]
l3_adj_ipcw_sl_M<-res_adj[[7]]

m1_adj_ipcw_sl_M<-res_adj[[2]]
m2_adj_ipcw_sl_M<-res_adj[[5]]
m3_adj_ipcw_sl_M<-res_adj[[8]]

lmr1_adj_ipcw_sl_M<-res_adj[[3]]
lmr2_adj_ipcw_sl_M<-res_adj[[6]]
lmr3_adj_ipcw_sl_M<-res_adj[[9]]
